...
# =====================================================
# обработка голосового и печать апдейта в терминал
# =====================================================
...
@dp.message(F.voice)
async def voice_process(mess: Message):
    await mess.reply('Голововое сообщение')
    print(mess.model_dump_json(indent=4))
